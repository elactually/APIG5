...
# Starting an infinite loop to repeatedly ask for new origin and destination inputs
while True:
    # Ask the user to input the starting location
    orig = input("Starting Location: ")
    # Ask the user to input the destination location
    dest = input("Destination: ")
    # Constructing the complete URL with the origin, destination, and API key
